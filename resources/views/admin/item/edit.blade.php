                    ...
                    <form action="{{ route('admin.item-update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name"
                                   placeholder="Masukkan nama barang" name="name" value="{{ $item->name }}">
                            <small class="text-danger">{{ $errors->first('name') }}</small>
                        </div>
                        <div class="form-group">
                            <label for="quantity">Jumlah</label>
                            <input type="number" class="form-control" id="quantity"
                                   placeholder="Masukkan jumlah barang" name="quantity" value="{{ $item->quantity }}">
                            <small class="text-danger">{{ $errors->first('quantity') }}</small>
                        </div>
                        <div class="form-group">
                            <label for="price">Harga @pcs</label>
                            <input type="number" class="form-control" id="price"
                                   placeholder="Masukkan harga barang @pcs" name="price" value="{{ $item->price }}">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="discount"
                                           placeholder="Masukkan harga barang" name="discount" value="{{ $item->discount }}">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="unit" name="unit">
                                        ...
                                        <option value="Harga" {{ $item->unit === "Harga" ? 'selected' : '' }}>Harga</option>
                                        <option value="Persentase" {{ $item->unit === "Persentase" ? 'selected' : '' }}>Persentase</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md">
                                ...
                                <img id="preview1" src="{{ Storage::url($item->image1) }}" alt="Image1" class="img-thumbnail"/>
                            </div>
                            <div class="col-md">
                                <label for="">Preview Gambar Kedua</label>
                                <img id="preview2" src="{{ Storage::url($item->image2) }}" alt="Image2" class="img-thumbnail"/>
                            </div>
                            <div class="col-md">
                                <label for="">Preview Gambar Ketiga</label>
                                <img id="preview3" src="{{ Storage::url($item->image3) }}" alt="Image1" class="img-thumbnail"/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
